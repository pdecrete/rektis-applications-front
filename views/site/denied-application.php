...
<div class="site-index">
	...
	<p class="text-center"><?= Html::a('<span class="glyphicon glyphicon-trash"></span> Ακύρωση δήλωσης άρνησης', ['application/recall-deny'], ['class' => 'btn btn-danger', 'data-confirm' => 'Είστε απολύτως βέβαιοι;', 'data-method' => 'POST']); ?></p>
</div>
