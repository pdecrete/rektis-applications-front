...
<?php if(1 == \Yii::$app->db->createCommand('SELECT enable_applications FROM config WHERE id=1')->queryColumn()[0]):?>
         <div class="jumbotron">
            ...
            <p><?= Html::a('Απενεργοποίηση', ['disable'], ['class' => 'btn btn-success', 'data-method' => 'POST', 'data-confirm' => 'Με την ενέργεια αυτή απενεργοποιείτε τη δυνατότητα υποβολής αιτήσεων για τους εκπαιδευτικούς. Είστε απόλυτα βέβαιοι;']) ?></p>
