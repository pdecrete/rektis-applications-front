...
<div class="body-content">
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <p>Η επιλογή αυτή θα διαγράψει όλα τα δεδομένα που αφορούν <strong>αιτήσεις</strong>, <strong>αιτούντες</strong>, <strong>κενά</strong>, <strong>περιφερειακές ενότητες</strong> και <strong>στοιχεία καταγραφής ενεργειών χρηστών</strong>.</p>
