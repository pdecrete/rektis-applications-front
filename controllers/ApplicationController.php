...
class ApplicationController extends Controller
{
    ...
    public function actionApply()
    {
		...
		Yii::$app->session->addFlash('info', "<p><h4><strong>Οδηγίες συμπλήρωσης φόρμας:</strong></h4>
							<ul><li>Μπορείτε να προσθέσετε από 1 έως " . Yii::$app->params['max-application-items'] ." επιλογές</li>
							<li>Για να προσθέσετε νέα επιλογή, πατήστε το κουμπί \"Προσθήκη Επιλογής\"</li>
